...
export default function FemaleDaily({ shoes }) {
  return (
    <div className="w-full">
      ...
      >
        {Object.keys(shoes.products.daily.women).map((key) => (
          <div key={shoes.products.daily.women[key].id}>
              ...
              <div className="border-2 border-black h-[350px] flex flex-col justify-start gap-y-5 w-[400px] rounded-xl p-4">
                <div className="flex justify-between  p-2">
                  <h1 className="font-semibold text-lg ">
                    {shoes.products.daily.women[key].name}
                  </h1>
                  <Link
                    to={`/femaledaily/${shoes.products.bestsellers.women[key].id}`}
                ...
                <div className=" w-full h-[250px] flex justify-center items-center">
                  <img src={shoes.products.daily.women[key].image} alt="" />
                </div>
              </div>
            </div>
          </div>
