...
export default function Daily({ shoes }) {
    return (
        <div className='w-full'>
            <h1 className='font-black text-4xl mb-4 mt-12 text-center'>Günlük Giyim</h1>
            <div id='mainarea' className='flex justify-center items-center flex-wrap gap-5 transition-all mx-auto p-10 '>
