...
export default function Dropdown({
  ...
  return (
    <Menu>
      ...
      >
        <MenuItem>
          <Link to={bestsellers} className="block data-[focus]:border-2  border-2 border-transparent data-[focus]:border-[#121212] p-4 rounded-xl font-semibold cursor-pointer">
            {productOne}
          </Link>
        </MenuItem>
        <MenuItem>
